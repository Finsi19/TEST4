          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'Finsi AI is an AI conversation application built with the Next.js framework. I will help you write the development documentation for Finsi AI.',
                tags: [
                ...
                title: 'Finsi AI Technical Documentation Expert',
              },
              type: 'agent',
